...
namespace Platform.Links.DataBase.Core.TreeMethods
{
    /// <remarks>
    ...
    /// </remarks>
    public unsafe abstract class SizeBalancedTreeMethods2
    {
        ...
        { 																																								
	        ...
	        { 																																							
		        ...
		        { 																																						
			        ...
			        if((*rootLeftNodeLeftNode != 0 && *rootLeftNodeLeftNode != 0) && (*rootRightNode == 0 || GetSize(*rootLeftNodeLeftNode) > GetSize(*rootRightNode)))										
				        RightRotate(root); 																																
			        else																																				
			        {																																					
				        var rootLeftNodeRightNode = GetRight(*rootLeftNode);
                        if ((*rootLeftNodeRightNode != 0 && *rootLeftNodeRightNode != 0) && (*rootRightNode == 0 || GetSize(*rootLeftNodeRightNode) > GetSize(*rootRightNode)))
                        {
        ...
        { 																																							
	        ...
	        { 																																						
		        ...
		        {																																					
			        ...
			        if (*rootRightNodeRightNode != 0 && (*rootLeftNode == 0 || GetSize(*rootRightNodeRightNode) > GetSize(*rootLeftNode)))								
				        LeftRotate(root);																															
			        else 																																			
			        {																																				
				        var rootRightNodeLeftNode = GetLeft(*rootRightNode);
                        if (*rootRightNodeLeftNode != 0 && (*rootLeftNode == 0 || GetSize(*rootRightNodeLeftNode) > GetSize(*rootLeftNode)))
                        {
